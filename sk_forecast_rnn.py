...
forecaster = ForecasterRecursiveMultiSeries(regressor          = LGBMRegressor(random_state=123, verbose=-1, max_depth=10), 
                 lags               = 400, 
...
# would not be an accurate test of forecasting (leaking data)
# lets copy and then drop the price column
